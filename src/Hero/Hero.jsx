      ...
      <div className="hero-container container">
        <div className="row">
          ...
          <div className="hero-row col-lg-6 col-sm-12">
            <p className="hero-p">
              Our <span className="hero-p-bold"> Early Career Coaching (ECC) </span> program is crafted to help you
              overcome challenges and position yourself for success in today’s competitive job market. Whether you’re a
              recent graduate or looking to pivot, we provide the tools and support you need to land the right job and
